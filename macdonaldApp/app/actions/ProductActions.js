...
const imageProductProcess = async (products) => {
  ...
  products.forEach(function(element) {
    ...
    let images = element.field_product_image
    for (let i = 0; i < images.length; i++) {
      let pos0 = element.field_product_image[i].indexOf('files/')
      let pos1 = element.field_product_image[i].indexOf('width=')
      element.field_product_image[i] = element.field_product_image[i].substring(pos0 + 6, pos1 - 2)
